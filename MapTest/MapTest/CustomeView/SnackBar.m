...
static SnackBar *currentlyVisibleSnackbar = nil;
...
+ (instancetype)snackbarWithMessage:(NSString *)message
                        ...
                        actionBlock:(void (^)(SnackBar *sender))actionBlock
                     dismissalBlock:(void (^)(SnackBar *sender))dismissalBlock {
    
    SnackBar *snackbar = [[SnackBar alloc] initWithMessage:message
...
- (void)drawRect:(CGRect)rect {
    ...
    [[UIColor colorWithWhite:0.1 alpha:0.75] setFill];
    UIBezierPath *clippath = [UIBezierPath bezierPathWithRoundedRect:rect cornerRadius:0];
    [clippath fill];
...
- (NSArray *)visibleVerticalLayoutConstraints {
    if (!_visibleVerticalLayoutConstraints) {
        ...
        [NSLayoutConstraint constraintsWithVisualFormat:@"V:[self(44)]-(0)-|"
                                                options:0
                                                metrics:nil
                                                  views:NSDictionaryOfVariableBindings(self)];
    }
...
- (NSArray *)horizontalLayoutConstraints {
    if (!_horizontalLayoutConstraints) {
        ...
        _horizontalLayoutConstraints = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-0-[self]-(0)-|"
                                                options:0
                                                metrics:nil
                                                  views:NSDictionaryOfVariableBindings(self)];
    }
